...
//        createContainer("");
    ...
    public void putBlob(BucketPath bucketPath, Payload payload) {
        ...
        StorageMetadataData storageMetadataData = StorageMetadataFlattener.fromJavaToProtoBuf(payload.getStorageMetadata());
    ...
    public StorageMetadata getStorageMetadata(BucketPath bucketPath) {
        try {
            ...
            return StorageMetadataFlattener.fromProtoBufToJava(storageMetadataData);
        } catch (Exception e) {
    ...
    public Payload getBlob(BucketPath bucketPath) {
        try {
            ...
            StorageMetadata storageMetadata = StorageMetadataFlattener.fromProtoBufToJava(storageMetadataData);
