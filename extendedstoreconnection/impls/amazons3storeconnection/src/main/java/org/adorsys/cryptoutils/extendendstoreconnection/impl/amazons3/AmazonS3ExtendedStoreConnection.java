...
public class AmazonS3ExtendedStoreConnection implements ExtendedStoreConnection {
    ...
    public AmazonS3ExtendedStoreConnection(URL url, AmazonS3AccessKey accessKey, AmazonS3SecretKey secretKey) {
        this(url, accessKey, secretKey, DEFAULT_REGION, DEFAULT_BUCKET);
    }
    ...
    public AmazonS3ExtendedStoreConnection(URL url, AmazonS3AccessKey accessKey, AmazonS3SecretKey secretKey, AmazonS3Region amazonS3Region) {
        this(url, accessKey, secretKey, amazonS3Region, DEFAULT_BUCKET);
    }

    public AmazonS3ExtendedStoreConnection(URL url, AmazonS3AccessKey accessKey, AmazonS3SecretKey secretKey, AmazonS3Region anAmazonS3Region, AmazonS3RootBucket anAmazonS3RootBucket) {
